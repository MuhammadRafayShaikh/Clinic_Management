...
namespace Clinic_Management.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, myDbContext myDbContext, IOptions<StripeSettings> stripeSettings, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
